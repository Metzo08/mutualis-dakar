...
export default function Cartographie({ lang }) {
  ...
  const locations = [
    ...
    { id: 2, name: 'MSD mutuelle de santé départementale de Dakar', type: 'office', subtype: 'départemental', lat: 14.6865, lng: -17.4475, desc: 'Dakar Plateau, immeuble municipal', phone: '+221 33 821 10 10', commune: 'Dakar Plateau', hours: '8h-16h', services: 'Bureau départemental de coordination', coverage: 'N/A' },
    { id: 3, name: 'MSD mutuelle de santé départementale de Pikine', type: 'office', subtype: 'départemental', lat: 14.7523, lng: -17.4011, desc: 'Pikine Ouest, Centre d\'Appui local', phone: '+221 33 851 44 22', commune: 'Pikine Ouest', hours: '8h-16h', services: 'Bureau départemental de coordination', coverage: 'N/A' },
    { id: 4, name: 'MSD mutuelle de santé départementale de Guédiawaye', type: 'office', subtype: 'départemental', lat: 14.7812, lng: -17.4124, desc: 'Golf Sud, cité des enseignants', phone: '+221 33 862 33 44', commune: 'Golf Sud', hours: '8h-16h', services: 'Bureau départemental de coordination', coverage: 'N/A' },
    { id: 5, name: 'MSD mutuelle de santé départementale de Rufisque', type: 'office', subtype: 'départemental', lat: 14.7154, lng: -17.2721, desc: 'Rufisque Nord, siège administratif', phone: '+221 33 871 12 12', commune: 'Rufisque Nord', hours: '8h-16h', services: 'Bureau départemental de coordination', coverage: 'N/A' },
    { id: 6, name: 'MSD mutuelle de santé départementale de Keur Massar', type: 'office', subtype: 'départemental', lat: 14.7891, lng: -17.3012, desc: 'Keur Massar Nord, cité ouvrière', phone: '+221 33 892 20 20', commune: 'Keur Massar Nord', hours: '8h-16h', services: 'Bureau départemental de coordination', coverage: 'N/A' },
  ...
  return (
    <div className="cartographie-view fade-in-up">
      ...
      <section className="banner-mini" style={{
        position: 'relative',
        background: 'linear-gradient(135deg, rgba(5, 150, 105, 0.38) 0%, rgba(16, 185, 129, 0.18) 100%), url("/csu_map_hero_real.png") center/cover no-repeat',
