  ...
  return (
    <div className="complaints-view fade-in-up">
      ...
      <section className="banner-mini" style={{
        background: 'linear-gradient(135deg, rgba(5, 150, 105, 0.38) 0%, rgba(16, 185, 129, 0.18) 100%), url("/bg_complaints_stock.jpg") center/cover no-repeat',
        ...
        <div style={{ textAlign: 'left', position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{ fontSize: '2.35rem', color: '#fff', marginBottom: '0.5rem', fontWeight: '800', textShadow: '0 3px 6px rgba(0,0,0,0.4)', letterSpacing: '-0.02em' }}>
            {portalMode === 'agent' ? t.titleAgent : t.titleCitizen}
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1.05rem', maxWidth: '800px', lineHeight: '1.6', textShadow: '0 1px 3px rgba(0,0,0,0.3)' }}>
