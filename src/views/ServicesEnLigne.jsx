  ...
  return (
    <div className="services-view fade-in-up">
      ...
      <section className="banner-mini" style={{
        background: `linear-gradient(135deg, rgba(5, 150, 105, 0.38) 0%, rgba(16, 185, 129, 0.18) 100%), url(${activeTab === 'donate' ? '"/services_donate_real.png"' : '"/services_join_real.png"'}) center/cover no-repeat`,
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <h1 style={{ color: '#fff', fontSize: '2.35rem', fontWeight: '800', marginBottom: '0.5rem', textShadow: '0 3px 6px rgba(0,0,0,0.4)', letterSpacing: '-0.02em' }}>Services en ligne</h1>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1.05rem', fontWeight: '500', maxWidth: '750px', margin: '0 auto', textShadow: '0 1px 3px rgba(0,0,0,0.3)', lineHeight: '1.6' }}>{lang === 'fr' ? 'Adhésion en ligne, paiement sécurisé des cotisations et solidarité communautaire.' : 'Bokk, fay sa cotisation ak mayé ci wér-gi-yaram.'}</p>
        </div>
      </section>
