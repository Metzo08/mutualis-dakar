...
export default function Home({ lang, setView, setViewTab, portalMode, setPortalMode, citizenUser, setCitizenUser, agentUser }) {
  ...
  const [recentActivities, setRecentActivities] = useState(() => {
    ...
    return [
      { 
        id: 1, 
        type: 'join', 
        text: 'Nouvelle adhésion famille', 
        detail: 'Famille Fall, mutuelle de la Médina', 
      ...
      { 
        id: 2, 
        type: 'payment', 
        text: 'Paiement de cotisation', 
        detail: 'Modou Diop, renouvellement 2026', 
      ...
      { 
        id: 3, 
        type: 'donation', 
        text: 'Don en ligne enregistré', 
        detail: 'Donateur anonyme, 10 000 FCFA', 
        createdAt: baseTime - 32 * 60 * 1000, 
        source: 'DON MUTUELLE' 
      }
    ];
  });
  ...
  const handlePrintCoverageReport = () => {
    ...
    printWin.document.write(`
      ...
      <html>
        ...
        <body>
          <div class="no-print">
            <button onclick="window.print()" class="btn btn-success btn-lg fw-bold px-4 py-2 me-2" style="background: #059669; border-color: #059669;">
              🖨️ Imprimer / Télécharger PDF
            </button>
            <button onclick="window.close()" class="btn btn-outline-secondary btn-lg fw-bold px-4 py-2">
              ❌ Fermer
            </button>
          </div>
          ...
          <div class="report-card">
            ...
            <div class="row mt-5 pt-3 border-top align-items-center">
              <div class="col-8">
                <small class="text-muted d-block fw-semibold" style="line-height: 1.5;">
                  Ce rapport officiel est généré dynamiquement par le système d'information <strong>MUTUALIS SÉNÉGAL</strong>.<br />
                  Toutes les données de couverture maladie sont certifiées et authentifiées par l'UNAMUSC.
                </small>
              </div>
  ...
  const dict = {
    ...
    wo: {
      ...
      heroBadge: 'Région bu Ndakaaru 🇸🇳',
      heroTitle: 'Yombat wér-gi-yaram ci Ndakaaru',
      heroSubtitle: 'Bindu ci mutuelle, fayal sa cotisation ci Wave walla Orange Money, am sa carte numérique.',
      heroBtnAdhesion: 'Bindu léegi',
      heroBtnMap: 'Xool fajukaay yi',
      statBeneficiaries: 'Ñi am carte',
      statMutuelles: 'Mutuelles',
      statHospitals: 'Fajukaay',
      statCoverage: 'Couverture',
      citizenWelcome: 'Dalal ak jàmm ci sa espace CSU !',
      citizenWelcomeDesc: 'Fayal sa cotisation te xool sa carte wér-gi-yaram.',
      citizenLoginPrompt: 'Xoolal sa carte CSU ak say droit',
      citizenLoginDesc: 'Duggalal sa portable ngir xool sa carte CSU, sa cotisation ak sa njabot.',
      phonePlaceholder: 'Ex: 77 123 45 67',
      pinPlaceholder: 'Code PIN (ex: 1234)',
      btnLogin: 'Duggu ci sama compte',
      demoNote: 'Duggu ko ak : 771234567 walla 779876543 (PIN: 1234)',
      citizenCardTitle: 'Sa carte QR CSU',
            ...
            <div className="card" style={{ flex: 1, textAlign: 'left' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  <button className="btn-text" style={{ fontSize: '0.8rem', padding: '0 0.5rem', cursor: 'pointer', background: 'transparent', border: 'none', color: 'var(--primary)' }} onClick={handlePrintCoverageReport}>{t.printBtn}</button>
                </div>
              </div>
                  ...
                  <div key={act.id} style={{ display: 'flex', gap: '0.75rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', flexShrink: 0 }}>
                      ...
                      <small style={{ color: 'var(--text-muted)', fontSize: '0.7rem', marginTop: '0.2rem' }}>
                        {getRelativeTimeString(act.createdAt || act.time)}
                      </small>
                    </div>
                  </div>
                ))}
