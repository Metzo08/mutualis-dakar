...
export default function ChatbotWidget({ lang, setView }) {
  ...
  const dict = {
    fr: {
      ...
      welcomeMsg: 'Bonjour ! Je suis Zahara, l\'assistance virtuelle de MUTUALIS DAKAR. Comment puis-je vous aider aujourd\'hui (adhésions, mutuelles, renouvellement, soins) ?',
      placeholder: 'Posez votre question sur la CSU...',
      sendBtn: 'Envoyer',
      quickTitle: 'Questions fréquentes :',
      quick1: 'Comment adhérer à une mutuelle ?',
      quick2: 'Quels sont les tarifs de cotisation ?',
      quick3: 'Où trouver les structures de santé ?',
    ...
    wo: {
      ...
      welcomeMsg: 'Na nga def ! Mangi tudd Zahara, assistant bu MUTUALIS DAKAR. Naka la lay mënë dimbalée taye (mbindu, mutuelle, fayut, fajukaay) ?',
      placeholder: 'Laajal lale la naxari ci CMU...',
      sendBtn: 'Yónnee',
      quickTitle: 'Laaj yi gënë siw :',
      quick1: 'Naka laay bokke ci mutuelle ?',
      quick2: 'Ñaata laay fay ci at mi ?',
      quick3: 'Ana fu fajukaay yi nekk ?',
